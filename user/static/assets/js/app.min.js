var app = {
  ...
  , handleScrollbar = function() {
    for (var e = document.querySelectorAll("[" + app.scrollBar.attr + "]"), t = 0; t < e.length; t++)
  ...
  , generateScrollbar = function(e) {
    ...
    e.style.height = t,
    e.scrollbarInit = !0,
    app.isMobile ? e.style.overflowX = "scroll" : (t = !!e.getAttribute(app.scrollBar.wheelPropagationAttr) && e.getAttribute(app.scrollBar.wheelPropagationAttr),
    e.closest("." + app.sidebar.class) && 0 !== e.closest("." + app.sidebar.class).length ? app.sidebar.scrollBar.dom = new PerfectScrollbar(e,{
        wheelPropagation: t
    }) : new PerfectScrollbar(e,{
        wheelPropagation: t
    })),
    e.setAttribute(app.init.attr, !0),
        ...
        e.onclick = function(e) {
            ...
            var t = this.nextElementSibling
              , e = (a.map(function(e) {
                ...
                e.closest("." + app.sidebar.menu.itemClass).classList.remove(app.sidebar.menu.expandClass))
            }),
            t.closest("." + app.sidebar.menu.itemClass));
            e.classList.contains(app.sidebar.menu.expandClass) || e.classList.contains(app.sidebar.menu.activeClass) && !t.style.display ? (e.classList.remove(app.sidebar.menu.expandClass),
            t.style.display = "none") : (e.classList.add(app.sidebar.menu.expandClass),
  ...
  , handleCardAction = function() {
    ...
    [].slice.call(document.querySelectorAll("[" + app.card.expand.toggleAttr + "]")).map(function(e) {
        return e.onclick = function(e) {
            ...
            document.body.classList.contains(t) && e.classList.contains(t) ? (e.removeAttribute("style"),
            e.classList.remove(t),
            document.body.classList.remove(t)) : (document.body.classList.add(t),
            e.classList.add(t)),
  ...
  , handleToggleClass = function() {
    [].slice.call(document.querySelectorAll("[" + app.toggleClass.toggleAttr + "]")).map(function(e) {
        e.onclick = function(e) {
            ...
            t && (a.classList.contains(e) || a.classList.contains(t)) ? (a.classList.contains(e) ? a.classList.remove(e) : a.classList.add(e),
            a.classList.contains(t) ? a.classList.remove(t) : a.classList.add(t)) : a.classList.contains(e) ? a.classList.remove(e) : a.classList.add(e)
        }
    })
}
  , handleThemePanel = function() {
    ...
    [].slice.call(document.querySelectorAll("[" + app.themePanel.toggleAttr + "]")).map(function(e) {
        e.onclick = function(e) {
            ...
            var e = document.querySelector("." + app.themePanel.class)
              , t = !1;
            e.classList.contains(app.themePanel.activeClass) ? e.classList.remove(app.themePanel.activeClass) : (e.classList.add(app.themePanel.activeClass),
            t = !0),
            Cookies && Cookies.set(app.themePanel.cookieName, t)
        }
    }),
    !Cookies || "true" != (e = Cookies.get(app.themePanel.cookieName)) && void 0 !== e || (e = document.querySelector("[" + app.themePanel.toggleAttr + "]")) && e.click(),
    [].slice.call(document.querySelectorAll("." + app.themePanel.class + " [" + app.themePanel.theme.toggleAttr + "]")).map(function(e) {
        e.onclick = function() {
            for (var e = 0; e < document.body.classList.length; e++) {
                var t = document.body.classList[e];
                -1 < t.search("theme-") && document.body.classList.remove(t)
            }
            var a = this.getAttribute(app.themePanel.theme.classAttr)
              , o = [].slice.call(document.querySelectorAll("." + app.themePanel.class + " [" + app.themePanel.theme.toggleAttr + "]"));
            ...
            Cookies && (Cookies.set(app.themePanel.theme.cookieName, a),
    ...
    Cookies && Cookies.get(app.themePanel.theme.cookieName) && (t = document.querySelector("." + app.themePanel.class + " [" + app.themePanel.theme.toggleAttr + "][" + app.themePanel.theme.classAttr + '="' + Cookies.get(app.themePanel.theme.cookieName) + '"]')) && (t.click(),
    app.color.theme = getComputedStyle(document.body).getPropertyValue("--bs-theme").trim(),
    app.color.themeRgb = getComputedStyle(document.body).getPropertyValue("--bs-theme-rgb").trim(),
    document.dispatchEvent(new Event("theme-reload"))),
    [].slice.call(document.querySelectorAll("." + app.themePanel.class + " [" + app.themePanel.themeCover.toggleAttr + "]")).map(function(e) {
        e.onclick = function(e) {
            e.preventDefault();
            for (var t = document.querySelector("html"), a = this.getAttribute(app.themePanel.themeCover.classAttr), o = 0; o < document.documentElement.classList.length; o++) {
                var s = document.documentElement.classList[o];
                -1 < s.search("bg-cover-") && t.classList.remove(s)
            }
            a && t.classList.add(a),
            [].slice.call(document.querySelectorAll("." + app.themePanel.class + " [" + app.themePanel.themeCover.toggleAttr + "]")).map(function(e) {
                e.getAttribute(app.themePanel.themeCover.toggleAttr) != a && e.closest("." + app.themePanel.themeCoverItemClass).classList.remove(app.themePanel.themeCover.activeClass)
            }),
            this.closest("." + app.themePanel.themeCoverItemClass).classList.add(app.themePanel.themeCover.activeClass),
            Cookies && Cookies.set(app.themePanel.themeCover.cookieName, a)
        }
    }),
    Cookies && Cookies.get(app.themePanel.themeCover.cookieName) && (t = document.querySelector("." + app.themePanel.class + " [" + app.themePanel.themeCover.toggleAttr + "][" + app.themePanel.themeCover.classAttr + '="' + Cookies.get(app.themePanel.themeCover.cookieName) + '"]')) && t.click(),
    [].slice.call(document.querySelectorAll("." + app.themePanel.class + " [" + app.themePanel.themeMode.toggleAttr + "]")).map(function(e) {
        e.onclick = function(e) {
            e.preventDefault();
            var t = this
              , e = t.getAttribute(app.themePanel.themeMode.valueAttr) ? t.getAttribute(app.themePanel.themeMode.valueAttr) : "";
            "dark" == e ? document.querySelector("html").setAttribute(app.themePanel.themeMode.attr, e) : document.querySelector("html").removeAttribute(app.themePanel.themeMode.attr),
            Cookies && Cookies.set(app.themePanel.themeMode.cookieName, e),
            t.classList.add(app.themePanel.themeMode.activeClass),
            [].slice.call(document.querySelectorAll("." + app.themePanel.class + " [" + app.themePanel.themeMode.toggleAttr + "]")).map(function(e) {
                e != t && e.classList.remove(app.themePanel.themeMode.activeClass)
            }),
            handleCssVariable(),
            document.dispatchEvent(new CustomEvent("theme-reload"))
        }
    }),
    Cookies && Cookies.get(app.themePanel.themeMode.cookieName) && (t = document.querySelector("." + app.themePanel.class + " [" + app.themePanel.themeMode.toggleAttr + "][" + app.themePanel.themeMode.valueAttr + '="' + Cookies.get(app.themePanel.themeMode.cookieName) + '"]')) && t.click()
}
  , handleCssVariable = function() {
    ...
    if (app.variableFontList && app.variablePrefix)
        for (var t = 0; t < app.variableFontList.length; t++)
            app.font[app.variableFontList[t].replace(/-([a-z|0-9])/g, (e, t) => t.toUpperCase())] = e.getPropertyValue("--" + app.variablePrefix + app.variableFontList[t]).trim();
    if (app.variableColorList && app.variablePrefix)
        for (t = 0; t < app.variableColorList.length; t++)
            app.color[app.variableColorList[t].replace(/-([a-z|0-9])/g, (e, t) => t.toUpperCase())] = e.getPropertyValue("--" + app.variablePrefix + app.variableColorList[t]).trim()
}
  , handleUnlimitedTopNavRender = function() {
    function t(e, t) {
        ...
        case "next":
            ...
            }, app.animation.speed)) : i = r - l - c,
            0 !== i && (a.style.transitionProperty = "height, margin, padding",
            a.style.transitionDuration = app.animation.speed + "ms",
            "rtl" != o.getPropertyValue("direction") ? a.style.marginLeft = "-" + i + "px" : a.style.marginRight = "-" + i + "px",
            setTimeout(function() {
                a.style.transitionProperty = "",
                a.style.transitionDuration = "",
                a.querySelector("." + app.topNav.control.class + "." + app.topNav.control.buttonPrev.class).classList.add("show")
            }, app.animation.speed));
            break;
        case "prev":
            var d, i = (d = -l) <= r ? (a.querySelector("." + app.topNav.control.class + "." + app.topNav.control.buttonPrev.class).classList.remove("show"),
            0) : d - r + c;
            ...
            setTimeout(function() {
                a.style.transitionProperty = "",
                a.style.transitionDuration = "",
                a.querySelector("." + app.topNav.control.class + "." + app.topNav.control.buttonNext.class).classList.add("show")
            }, app.animation.speed)
        }
    }
    function a() {
        var e, t, a, o, s, l, r, n, i = document.querySelector("." + app.topNav.class + " ." + app.topNav.menu.class);
        i && (t = window.getComputedStyle(i),
        n = "rtl" == (e = window.getComputedStyle(document.body)).getPropertyValue("direction") ? "margin-right" : "margin-left",
        parseInt(t.getPropertyValue(n)),
        t = document.querySelector("." + app.topNav.class).clientWidth,
        o = a = 0,
        (n = i.querySelector(".menu-control-start")) && n.clientWidth,
        s = i.querySelector(".menu-control-end"),
        n = n ? s.clientWidth : 0,
        s = 0,
        (r = [].slice.call(document.querySelectorAll("." + app.topNav.class + " ." + app.topNav.menu.class + " > ." + app.topNav.menu.itemClass))) && (l = !1,
        r.map(function(e) {
            e.classList.contains("menu-control") || (o += e.clientWidth,
            l || (a += e.clientWidth),
            e.classList.contains("active") && (l = !0))
        })),
        r = i.querySelector("." + app.topNav.control.class + "." + app.topNav.control.buttonNext.class),
        a != o && t <= o ? (r.classList.add(app.topNav.control.showClass),
        s += n) : r.classList.remove(app.topNav.control.showClass),
        r = i.querySelector("." + app.topNav.control.class + "." + app.topNav.control.buttonPrev.class),
        t <= a && t <= o ? r.classList.add(app.topNav.control.showClass) : r.classList.remove(app.topNav.control.showClass),
        t <= a) && (n = a - t + s,
        "rtl" != e.getPropertyValue("direction") ? i.style.marginLeft = "-" + n + "px" : i.style.marginRight = "-" + n + "px")
    }
    var e = document.querySelector("[" + app.topNav.control.buttonNext.toggleAttr + "]");
    function o(e) {
        let n = document.querySelector(e);
        if (n) {
            let t = n.querySelector(".menu");
            e = t.querySelectorAll(".menu-item:not(.menu-control)");
            let a, o, s, l = 0, r = 0;
            e.forEach(e => {
                l += e.offsetWidth
            }
            ...
            n.addEventListener("mousemove", e => {
                a && s && (window.innerWidth < app.breakpoints.md || (e.preventDefault(),
                e = e.pageX - a,
                (e = o + e) <= r ? (e = r,
                t.querySelector("." + app.topNav.control.class + "." + app.topNav.control.buttonNext.class).classList.remove("show")) : t.querySelector("." + app.topNav.control.class + "." + app.topNav.control.buttonNext.class).classList.add("show"),
                l < n.offsetWidth && t.querySelector("." + app.topNav.control.class + "." + app.topNav.control.buttonPrev.class).classList.remove("show"),
                0 < r && t.querySelector("." + app.topNav.control.class + "." + app.topNav.control.buttonNext.class).classList.remove("show"),
                0 < e ? (e = 0,
                t.querySelector("." + app.topNav.control.class + "." + app.topNav.control.buttonPrev.class).classList.remove("show")) : t.querySelector("." + app.topNav.control.class + "." + app.topNav.control.buttonPrev.class).classList.add("show"),
                t.style.marginLeft = e + "px"))
            }
            ),
            n.addEventListener("touchmove", e => {
                a && s && (window.innerWidth < app.breakpoints.md || (e.preventDefault(),
                e = e.targetTouches[0].pageX - a,
                (e = o + e) <= r ? (e = r,
                t.querySelector("." + app.topNav.control.class + "." + app.topNav.control.buttonNext.class).classList.remove("show")) : t.querySelector("." + app.topNav.control.class + "." + app.topNav.control.buttonNext.class).classList.add("show"),
                l < n.offsetWidth && t.querySelector("." + app.topNav.control.class + "." + app.topNav.control.buttonPrev.class).classList.remove("show"),
                0 < r && t.querySelector("." + app.topNav.control.class + "." + app.topNav.control.buttonNext.class).classList.remove("show"),
    ...
    window.addEventListener("resize", function() {
        var e;
        window.innerWidth >= app.breakpoints.md && ((e = document.querySelector("." + app.topNav.class)) && e.removeAttribute("style"),
        (e = document.querySelector("." + app.topNav.class + " ." + app.topNav.menu.class)) && e.removeAttribute("style"),
        (e = document.querySelectorAll("." + app.topNav.class + " ." + app.topNav.menu.submenu.class)) && e.forEach(e => {
    ...
    window.innerWidth >= app.breakpoints.md && (a(),
    o("." + app.topNav.class))
}
  , handleTopNavToggle = function(a, o=!1) {
    a.map(function(e) {
        e.onclick = function(e) {
            var t;
            e.preventDefault(),
            (!o || document.body.clientWidth < app.breakpoints.md) && (t = this.nextElementSibling,
            a.map(function(e) {
                e = e.nextElementSibling;
                e !== t && (slideUp(e),
                e.closest("." + app.topNav.menu.itemClass).classList.remove(app.topNav.menu.expandClass),
                e.closest("." + app.topNav.menu.itemClass).classList.add(app.topNav.menu.closedClass))
            }),
            slideToggle(t))
        }
    })
  ...
  , slideUp = function(e, t=app.animation.speed) {
    e.classList.contains("transitioning") || (e.classList.add("transitioning"),
