...
sio = socketio.Server(async_mode='gevent', cors_allowed_origins='*', ping_interval=25, ping_timeout=60)
app = Flask(__name__)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Test Flask Socket.IO server for camera or VNC')
    parser.add_argument('--port', type=int, default=5001, help='Port to listen on (5001 for camera, 5002 for VNC)')
